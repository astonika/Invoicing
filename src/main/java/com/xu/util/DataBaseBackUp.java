...
public class DataBaseBackUp {
    ...
    public static void init(){
        ...
        InputStream in = DataBaseBackUp.class.getResourceAsStream("/com/xu/uti/db.properties");
        try {
            p.load(in);
            in.close();
            backuppath = (String) p.get("backuppath");
            restorepath = p.getProperty("restorepath");
        } catch (IOException e) {
            e.printStackTrace();
        }
    }*/
    public static void backup(){
        ...
        try {
            ...
            // 调用 调用mysql安装目录的命令
            Process child = rt.exec("D:\\tools\\mysql\\bin\\mysqldumb -h localhost -uroot -proot jxc");
